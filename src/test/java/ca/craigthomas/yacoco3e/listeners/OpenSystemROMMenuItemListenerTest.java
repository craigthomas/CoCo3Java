...
public class OpenSystemROMMenuItemListenerTest
{
    private OpenSystemROMMenuItemActionListener listener;
    private OpenSystemROMMenuItemActionListener listenerSpy;
    ...
    public void setUp() {
        ...
        listener = new OpenSystemROMMenuItemActionListener(emulator);
    ...
    @Test
    public void testOpenSystemROMDialogShowsWhenClicked() {
