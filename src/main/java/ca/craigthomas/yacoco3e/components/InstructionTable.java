    ...
    private static final Instruction[] INSTRUCTIONS =
        {
            ...
            new VoidInstruction(0x0E, 3, "JMP",  DIRECT, VoidInstruction::unconditionalJump, false, false),
            ...
            new VoidInstruction(0x12, 2, "NOP",  INHERENT, VoidInstruction::noOperation, false, false),
            new VoidInstruction(0x13, 0, "SYNC", INHERENT, VoidInstruction::sync, false, false),
            ...
            new ByteRegisterInstruction(0x1D, 2, "SEX",  INHERENT, ByteInstruction::signExtend, Register.A),
            new VoidInstruction(0x1E, 8, "EXG", IMMEDIATE, VoidInstruction::exchangeRegister, true, false),
            new VoidInstruction(0x1F, 6, "TFR", IMMEDIATE, VoidInstruction::transferRegister, true, false),
            ...
            new VoidInstruction(0x39, 5, "RTS", INHERENT, VoidInstruction::returnFromSubroutine, false, false),
            new WordRegisterInstruction(0x3A, 3, "ABX",  INHERENT, WordRegisterInstruction::addBtoX, Register.X),
            new VoidInstruction(0x3B, 0,  "RTI", INHERENT, VoidInstruction::returnFromInterrupt, false, true),
            new VoidInstruction(0x3C, 20, "CWAI", IMMEDIATE, VoidInstruction::callAndWaitForInterrupt, true, false),
            ...
            new VoidInstruction(0x3F, 19, "SWI", INHERENT, VoidInstruction::softwareInterrupt, false, false),
            new ByteRegisterInstruction(0x40, 2, "NEGA", INHERENT, ByteInstruction::negate, Register.A),
            new NotImplementedInstruction(0x41),
            new NotImplementedInstruction(0x42),
            new ByteRegisterInstruction(0x43, 2, "COMA", INHERENT, ByteInstruction::compliment, Register.A),
            new ByteRegisterInstruction(0x44, 2, "LSRA", INHERENT, ByteInstruction::logicalShiftRight, Register.A),
            new NotImplementedInstruction(0x45),
            new ByteRegisterInstruction(0x46, 2, "RORA", INHERENT, ByteInstruction::rotateRight, Register.A),
            new ByteRegisterInstruction(0x47, 2, "ASRA", INHERENT, ByteInstruction::arithmeticShiftRight, Register.A),
            new ByteRegisterInstruction(0x48, 2, "ASLA", INHERENT, ByteInstruction::arithmeticShiftLeft, Register.A),
            new ByteRegisterInstruction(0x49, 2, "ROLA", INHERENT, ByteInstruction::rotateLeft, Register.A),
            new ByteRegisterInstruction(0x4A, 2, "DECA", INHERENT, ByteInstruction::decrement, Register.A),
            new NotImplementedInstruction(0x4B),
            new ByteRegisterInstruction(0x4C, 2, "INCA", INHERENT, ByteInstruction::increment, Register.A),
            new ByteRegisterInstruction(0x4D, 2, "TSTA", INHERENT, ByteInstruction::testByte, Register.A),
            new NotImplementedInstruction(0x4E),
            new ByteRegisterInstruction(0x4F, 2, "CLRA", INHERENT, ByteInstruction::clear, Register.A),
            new ByteRegisterInstruction(0x50, 2, "NEGB", INHERENT, ByteInstruction::negate, Register.B),
            new NotImplementedInstruction(0x51),
            new NotImplementedInstruction(0x52),
            new ByteRegisterInstruction(0x53, 2, "COMB", INHERENT, ByteInstruction::compliment, Register.B),
            new ByteRegisterInstruction(0x54, 2, "LSRB", INHERENT, ByteInstruction::logicalShiftRight, Register.B),
            new NotImplementedInstruction(0x55),
            new ByteRegisterInstruction(0x56, 2, "RORB", INHERENT, ByteInstruction::rotateRight, Register.B),
            new ByteRegisterInstruction(0x57, 2, "ASRB", INHERENT, ByteInstruction::arithmeticShiftRight, Register.B),
            new ByteRegisterInstruction(0x58, 2, "ASLB", INHERENT, ByteInstruction::arithmeticShiftLeft, Register.B),
            new ByteRegisterInstruction(0x59, 2, "ROLB", INHERENT, ByteInstruction::rotateLeft, Register.B),
            new ByteRegisterInstruction(0x5A, 2, "DECB", INHERENT, ByteInstruction::decrement, Register.B),
            new NotImplementedInstruction(0x5B),
            new ByteRegisterInstruction(0x5C, 2, "INCB", INHERENT, ByteInstruction::increment, Register.B),
            new ByteRegisterInstruction(0x5D, 2, "TSTB", INHERENT, ByteInstruction::testByte, Register.B),
            new NotImplementedInstruction(0x5E),
            new ByteRegisterInstruction(0x5F, 2, "CLRB", INHERENT, ByteInstruction::clear, Register.B),
            ...
            new VoidInstruction(0x6E, 3, "JMP",  INDEXED, VoidInstruction::unconditionalJump, false, false),
            ...
            new VoidInstruction(0x7E, 4, "JMP",  EXTENDED, VoidInstruction::unconditionalJump, false, false),
            ...
            new ByteRegisterInstruction(0x88, 2, "EORA", IMMEDIATE, ByteInstruction::exclusiveOr, Register.A),
            ...
            new ByteRegisterInstruction(0x98, 4, "EORA", DIRECT, ByteInstruction::exclusiveOr, Register.A),
            ...
            new VoidInstruction(0x9D, 7, "JSR", DIRECT, VoidInstruction::jumpToSubroutine, false, false),
            ...
            new ByteRegisterInstruction(0xA8, 2, "EORA", INDEXED, ByteInstruction::exclusiveOr, Register.A),
            ...
            new VoidInstruction(0xAD, 5, "JSR", INDEXED, VoidInstruction::jumpToSubroutine, false, false),
            ...
            new ByteRegisterInstruction(0xB8, 5, "EORA", EXTENDED, ByteInstruction::exclusiveOr, Register.A),
            ...
            new VoidInstruction(0xBD, 8, "JSR", EXTENDED, VoidInstruction::jumpToSubroutine, false, false),
            ...
            new ByteRegisterInstruction(0xC8, 2, "EORB", IMMEDIATE, ByteInstruction::exclusiveOr, Register.B),
            ...
            new ByteRegisterInstruction(0xD8, 4, "EORB", DIRECT, ByteInstruction::exclusiveOr, Register.B),
            ...
            new ByteRegisterInstruction(0xE8, 2, "EORB", INDEXED, ByteInstruction::exclusiveOr, Register.B),
            ...
            new ByteRegisterInstruction(0xF8, 5, "EORB", EXTENDED, ByteInstruction::exclusiveOr, Register.B),
    ...
    private static final Instruction[] EXTENDED_INSTRUCTIONS =
        {
                ...
                new VoidInstruction(0x103F, 19, "SWI3", INHERENT, VoidInstruction::softwareInterrupt3, false, false),
    ...
    private static final Instruction[] COMPARE_INSTRUCTIONS =
        {
                ...
                new VoidInstruction(0x113F, 20, "SWI2", INHERENT, VoidInstruction::softwareInterrupt2, false, false),
