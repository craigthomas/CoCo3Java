 ...
 */
public class RecordCassetteMenuItemActionListener implements ActionListener
{
    private Cassette cassette;
    private Emulator emulator;

    public RecordCassetteMenuItemActionListener(Emulator emulator, Cassette cassette) {
        super();
    ...
    public void actionPerformed(ActionEvent e) {
        cassette.record();
        emulator.saveCassetteFileDialog();
    }
}
